...
async def statement_add(statement_data: statement_schema.StatementSchemaAdd = Depends(), session: AsyncSession = Depends(session.get_db_session))-> statement_schema.StatementSchemaAdd:
